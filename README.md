...
Shortly after getting to the end of the non-AI version, I realized that I hadn't actually accomplished very much, as described more below. I decided to go ahead and try to build the same project using ChatGPT as an aide. That version is [located here](https://github.com/natedugg/icapital-with-ai).
