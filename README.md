...
- The ability to merge accounts based on matching names / SSNs
  - when adding a new investor and checking for value matches within existing investor accounts, possibly using the union-find / disjoint-set algorithm to generate the list of matching accounts
